...
public abstract class DataRepositoryManager <T,ID extends Serializable> implements Serializable{
    ...
    protected DataRepositoryManager(Class<T> entityClass){
    ...
    public T createEntity(InputStream inputStream){
        try{
